    ...
    else if(publisherProxy->topicType == "interfaces/msg/CartData")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<interfaces::msg::CartData> > >(publisherProxy->publisher);
        interfaces::msg::CartData msg;
        read__interfaces__msg__CartData(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
