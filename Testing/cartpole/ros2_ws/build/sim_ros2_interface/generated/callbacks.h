...
#include <interfaces/msg/cart_data.hpp>
...
void write__interfaces__msg__CartData(const interfaces::msg::CartData& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__interfaces__msg__CartData(int stack, interfaces::msg::CartData *msg, const ROS2ReadOptions *opt = NULL);
